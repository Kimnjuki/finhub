...
export const tvOrderType = v.union(v.literal('market'), v.literal('limit'), v.literal('stop'), v.literal('stop_limit'), v.literal('trailing_stop'));
export const tvOrderSide = v.union(v.literal('buy'), v.literal('sell'), v.literal('short'), v.literal('cover'));
export const tvOrderStatus = v.union(v.literal('pending'), v.literal('placed'), v.literal('partially_filled'), v.literal('filled'), v.literal('canceled'), v.literal('rejected'), v.literal('expired'));
export const tvTimeInForce = v.union(v.literal('GTC'), // Good 'Til Canceled
v.literal('IOC'), // Immediate or Cancel
v.literal('FOK'), // Fill or Kill
v.literal('GTD') // Good 'Til Date
);
export const tvExchangeName = v.union(v.literal('binance'), v.literal('coinbase'), v.literal('kraken'), v.literal('bybit'), v.literal('okx'), v.literal('deribit'));
/**
...
export const exchangeCredentials = defineTable({
    ...
    // Permissions scope
    permissions: v.array(v.union(v.literal('read'), v.literal('trade'), v.literal('withdraw'))),
...
export const tvWebhookEvents = defineTable({
    ...
    // Result
    processingStatus: v.union(v.literal('received'), v.literal('parsed'), v.literal('mapped'), v.literal('order_placed'), v.literal('order_failed'), v.literal('rejected'), v.literal('skipped')),
